...
%% appendicies entry is alone at the foot of the page.
...
\newpagestyle{main}[\defaultfont\bfseries]{%
  \headrule
\sethead%
[\ifthesection{\thesection{.} \space}{\ifthechapter{\thechapter{.} \space}{}}
\ifthesection{\sectiontitle}{\ifthechapter{\chaptertitle}{
