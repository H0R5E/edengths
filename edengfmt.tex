...
%% Set the space to the footer
\geometry{footskip=20mm - 1em}
...
%% you start to get looks of bad boxs. Try to set this number as high as
...
%% makes sure it won't mess up if hyper option is not used.
...
%       urlcolor=Black 
  ...
  %% as when using hyperref it links``title number'' rather 
