...
\documentclass[fancychap]{edengths}
...
%% dimensions, header/footers and other bits can be altered.
...
% \graphicspath{{/chapter_2/}{/chapter_3/}{chapter_4/}
...
%% Note: latex needs a eps file, while pdf lates needs pdf or jpg.
